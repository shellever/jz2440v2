...
// S3C2440_UserManual_Rev13.pdf p60
typedef struct {
    S3C24X0_REG32 NFCONF;       // Nand Flash configuration register
    S3C24X0_REG32 NFCONT;       // Nand Flash control register
    S3C24X0_REG32 NFCMD;        // Nand Flash command set register
    S3C24X0_REG32 NFADDR;       // Nand Flash address set register
    S3C24X0_REG32 NFDATA;       // Nand Flash data register
    S3C24X0_REG32 NFMECCD0;     // Nand Flash ECC 1st and 2nd register for main data read
    S3C24X0_REG32 NFMECCD1;     // Nand Flash ECC 3nd and 4th register for main data read 
    S3C24X0_REG32 NFSECCD;      // Nand Flash ECC register for spare area data read
