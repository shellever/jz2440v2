...
#define MODE_TFT_8BIT_480272	(0x4301)
#define MODE_TFT_16BIT_480272	(0x4302)
...
#define CLKVAL_TFT_480272		(4)

//Timing parameter for AT043TN24 4.3inch
#define VBPD_480272				((2-1)&0xff)
#define VFPD_480272				((2-1)&0xff)
#define VSPW_480272			    ((10-1) &0x3f)
#define HBPD_480272				((2-1)&0x7f)
#define HFPD_480272				((2-1)&0xff)
#define HSPW_480272			    ((41-1)&0xff)
